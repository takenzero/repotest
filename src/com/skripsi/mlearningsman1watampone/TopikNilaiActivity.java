...
public class TopikNilaiActivity extends ListActivity {
	public String id, nis, nama, v_id, v_judul, link;
    ...
    class AmbilData extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(TopikNilaiActivity.this);
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                	ListAdapter adapter = new SimpleAdapter(
							TopikNilaiActivity.this, data_map,
                    ...
                    lv.setOnItemClickListener(new OnItemClickListener() {
            			...
            			public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
            				...
            				v_judul = ((TextView) view.findViewById(R.id.topik_judul)).getText().toString();
            				
            				Intent in = new Intent(TopikNilaiActivity.this, DetailNilaiActivity.class);
            				Bundle b = new Bundle();
            				b.putString("par_id", v_id);
            				b.putString("par_nis", nis);
            				b.putString("par_judul", v_judul);
            				b.putString("par_nama", nama);
            				in.putExtras(b);
            				startActivity(in);
                    	}
                    });
